      ...
      <ul className="navbar-nav">
        ...
        <li className="nav-item" id="themeButton">
          <button
            className="nav-link"
          >
            <span id="theme-text" className="link-text">
              Day Mode
            </span>
            <svg
              className="svg-inline--fa fa-linkedin fa-w-14 night-mode-icon"
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
            ...
            <svg
              className="svg-inline--fa fa-linkedin fa-w-14 day-mode-icon"
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
              data-icon="sun"
